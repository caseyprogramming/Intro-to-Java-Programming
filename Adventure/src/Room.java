...
public class Room {
	...
	/**
	 * Returns the lamp object in this room. If no lamp is present, returns null
	 */
	public Lamp getLamp() {
		return theLamp;
	}
	...
	/**
	 * Returns the key object in this room. If no key is present, returns null
	 */
	public Key getKey() {
		return theKey;
	}
	...
	/**
	 * Returns the chest object in this room. If no chest is present, returns null
	 */
	...
	/**
	 * Returns true if there is no light in this room, veeeeeeeery dangerous!
	 */
	 ...
	 * 
	 */
	public Room(String description, boolean north, boolean south, boolean east, boolean west, boolean isDark,
			Lamp theLamp, Key theKey, Chest theChest) {
		super();
